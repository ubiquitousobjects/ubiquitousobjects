...
internal class TypescriptProcessExecutionContext : IExecutionContext, IAsyncDisposable
{
    ...
    public TypescriptProcessExecutionContext(string source)
    {
        this.ExecutionContextType = ExecutionContextType.TYPESCRIPT_PROC;
        this._source = source;
    }
